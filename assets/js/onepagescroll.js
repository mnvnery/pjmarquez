...
function onePageScroll(element, options) {
  ...
  this.init = function() { 
    ...
    /*-------------------------------------------*/
  	...
  	if(window.location.hash != "" && window.location.hash != "#1") {
  		...
  		_addClass( document.querySelector(settings.sectionContainer + "[data-index='" + init_index + "']") ,"act")
  		_addClass(body, "viewing-page-"+ init_index)
  		if(settings.pagination == true) _addClass(document.querySelector(".onepage-pagination li a" + "[data-index='" + init_index + "']"), "act");
  	  ...
  	  _addClass(document.querySelector(settings.sectionContainer + "[data-index='1']"), "act");
  	  _addClass(body, "viewing-page-1");
  		if(settings.pagination == true) _addClass(document.querySelector(".onepage-pagination li a[data-index='1']"), "act");
  	}
  ...
  /*---------------------------------*/
   ...
   this.moveDown = function(el3) {
    ...
    var index = document.querySelector(settings.sectionContainer +".act").dataset.index,
		...
		_removeClass(current, "act");
		_addClass(next, "act");
		
		if(settings.pagination == true) {
		  _removeClass(document.querySelector(".onepage-pagination li a" + "[data-index='" + index + "']"), "act");
		  _addClass(document.querySelector(".onepage-pagination li a" + "[data-index='" + next_index + "']"), "act");
		}
  ...
  this.moveTo = function(el5, page_index) {
    ...
    if (typeof el5 == "string") el5 = document.querySelector(el5);
		...
		var current = document.querySelector(settings.sectionContainer + ".act"),
		...
		if(next) {
		  var next_index = next.dataset.index;
			_removeClass(current, "act");
			_addClass(next, "act");
			_removeClass(document.querySelector(".onepage-pagination li a" + ".act"), "act");
			_addClass(document.querySelector(".onepage-pagination li a" + "[data-index='" + (page_index) + "']"), "act");
